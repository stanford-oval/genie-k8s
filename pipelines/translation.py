...
def translate_dialogue_pipeline(
    ...
    experiment='bitod_en',
    s3_bucket='geniehai',
    s3_datadir='s3://geniehai/mehrad/dataset/zeroshot/bitod/en_v10/',
    source='en_v10',
    input_splits='valid',
    translation_model='Helsinki-NLP/opus-mt-$(src_lang)-$(tgt_lang)',
    nmt_id='marian',
    ...
    tgt_lang='zh',
    image=default_image,
    genienlp_version='68ddc3e8ac0c2cb193451a7acdf35e8f03fca4bf',
    genie_version='7d119aeadcbc56c2e0f1ea2c9b3023c162e78212',
    ...
    additional_args='val_batch_size=2000 temperature=0.2',
):
