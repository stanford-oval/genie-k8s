...
def train_predict_bitod_pipeline(
    ...
    s3_database_dir='None',
    model_type='None',
    s3_nlg_model='s3://geniehai/mehrad/models/e2e/bitod_nlg/nlg_mbart_large_v16_5e-5_linear/1638769842/',
    image=default_image,
    genienlp_version='',
    load_from='None',
    valid_set='valid',
...
def predict_bitod_pipeline(
    ...
    s3_bootleg_prepped_data='None',
    val_batch_size='4000',
    pred_additional_args='--extra_metrics bitod_score --bitod_e2e_evaluation --subsample 20',
):
