...
def train_predict_pipeline(
    ...
    model='test_fa_2',
    task_name='bitod',
    s3_datadir='/shared/data/michael/dataset/zeroshot/bitod/fa/v1/',
    s3_bucket='geniehai',
    s3_database_dir='None',
    model_type='None',
    image='stanfordoval.azurecr.io/genie/kubeflow:20220815',
    ...
    train_additional_args='--subsample 100 --max_output_length 205 --train_batch_tokens 800 --lr_multiply 2e-5 --warmup 1 --lr_schedule linear --override_question= --val_batch_size 4000 --force_fast_tokenizer --pretrained_model facebook/mbart-large-50',
    val_batch_size='4000',
    pred_additional_args='',
):
    train_op = training.train_step(
...
def predict_pipeline(
    ...
    task_name='bitod',
    genienlp_version='561937cb50b84b1ebc5eda5c00e82a861cf56814',
    model_name_or_path='/shared/data/giulianna/models/zeroshot/bitod/test_fa_2/1660757867/',
    s3_input_datadir='/shared/data/michael/dataset/zeroshot/bitod/fa/v1/',
    s3_database_dir='None',
    s3_bootleg_prepped_data='None',
    model_type='None',
    dataset_subfolder='None',
