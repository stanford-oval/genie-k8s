...
from . import train_step, split_bootleg_merge_step
from .common import *
...
@dsl.pipeline(
    name='Bootleg, train, and prediction pipeline',
    description='Bootleg the dataset, train a model and do prediction'
)
...
@dsl.pipeline(
    ...
    description='Train a model and do prediction'
)
