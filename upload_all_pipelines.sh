...
python3 upload_pipeline.py gpu_generate_train_eval_pipeline gpu-generate-train-eval
...
python3 upload_pipeline.py generate_bootleg_filtering_train_eval_pipeline generate-bootleg-filtering-train-eval
python3 upload_pipeline.py gpu_generate_bootleg_train_eval_pipeline gpu-generate-bootleg-train-eval
python3 upload_pipeline.py gpu_generate_bootleg_filtering_train_eval_pipeline gpu-generate-bootleg-filtering-train-eval
python3 upload_pipeline.py bootleg_train_eval_pipeline bootleg-train-eval
python3 upload_pipeline.py bootleg_filtering_train_eval_pipeline bootleg-filtering-train-eval
...
python3 upload_pipeline.py generate_bootleg_paraphrase_train_eval_pipeline generate-bootleg-paraphrase-train-eval
python3 upload_pipeline.py generate_bootleg_filtering_paraphrase_train_eval_pipeline generate-bootleg-filtering-paraphrase-train-eval
...
python3 upload_pipeline.py gpu_generate_bootleg_filtering_paraphrase_train_eval_pipeline gpu-generate-bootleg-filtering-paraphrase-train-eval
